...
#include "capnp/contestgenerator.capnp.h"
...
protected:
    virtual ::kj::Promise<void> getContest(GetContestContext context);
    virtual ::kj::Promise<void> getContests(GetContestsContext context);
